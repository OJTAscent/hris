            ...
            <div class="card-body">
                ...
                <form action="{{ route('registration.store') }}" method="POST" class="p-4" id="form"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6 mb-2">
                                            ...
                                            <input type="text" class="form-control"
                                                {{ $mode == 'show' ? 'disabled' : 'disabled' }} name="employee[employee_number]"
                                                placeholder="Employee Number: 2022-0000" id="employee_number"
                                                value="{{ isset($registration->employee_number) ? $registration->employee_number : '' }}">
                                        </div>
                                    </div>
                    ...
                    <div class="card shadow " id="emergency" {{-- style="display:none" --}}>
                        <div class="card-body">
                            <h5 class="card-title pb-4 border-bottom border-sucess text-center">
                                ...
                                <div class="form-emer">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12 mb-2">
                                            ...
                                            <input type="hidden" name="emergency[employee_id]" id="id"
                                                value="{{ $registration->id }}">
                                        ...
                                        <div class="form-group col-lg-6  mb-4">
                                            <input type="text" {{ $mode == 'show' ? 'disabled' : '' }}
                                                class="form-control" name="emergency[contact_firstname]"
                                                id="contact_firstname" pattern="^\D*$"
                                        ...
                                        <div class="form-group col-lg-6  mb-4">
                                            <input type="text" {{ $mode == 'show' ? 'disabled' : '' }}
                                                class="form-control " name="emergency[contact_lastname]"
                                                id="contact_lastname" pattern="^\D*$"
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" {{ $mode == 'show' ? 'disabled' : '' }} class="form-control"
                                            name="emergency[contact_phonenumber]" placeholder="(000)000-0000"
                                            id="contact_phonenumber" value="{{ $emergency->contact_phonenumber }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <input type="text" class="form-control"
                                                {{ $mode == 'show' ? 'disabled' : '' }}
                                                name="emergency[secondcontact_fname]" id="secondcontact_fname"
                                                pattern="^\D*$" value="{{ $emergency->secondcontact_fname }}">
                                            <div id="" class="form-text">First Name</div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <input type="text" class="form-control"
                                                {{ $mode == 'show' ? 'disabled' : '' }}
                                                name="emergency[secondcontact_lname]" id="secondcontact_lname"
                                                pattern="^\D*$" value="{{ $emergency->secondcontact_lname }}">
                                            <div id="" class="form-text">Last Name</div>
                                        </div>
                                    </div>
                                    ...
                                    <button id="back" type="button"
                                        class="btn btn-secondary pe-4 ps-4 float-start">Back</button>
